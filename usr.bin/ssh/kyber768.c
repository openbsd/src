...
int crypto_kem_kyber768_keypair(uint8_t *pk, uint8_t *sk);

int crypto_kem_kyber768_enc(uint8_t *ct, uint8_t *ss, const uint8_t *pk);

int crypto_kem_kyber768_dec(uint8_t *ss, const uint8_t *ct, const uint8_t *sk);
...
static void kyber_aes256xof_absorb(aes256ctr_ctx *state, const uint8_t seed[32], uint8_t x, uint8_t y);

static void kyber_aes256ctr_prf(uint8_t *out, size_t outlen, const uint8_t key[32], uint8_t nonce);
