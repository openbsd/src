/*	$OpenBSD: netbsd_sysent.c,v 1.9 1999/09/17 22:15:35 kstailey Exp $	*/
...
struct sysent netbsd_sysent[] = {
	...
	{ 5, s(struct sys_semsys_args),
	    sys_semsys },			/* 169 = osemsys */
#else
	{ 0, 0,
	    sys_nosys },			/* 169 = unimplemented 1.0 semsys */
#endif
#if defined(SYSVMSG) && !defined(alpha)
	{ 6, s(struct sys_msgsys_args),
	    sys_msgsys },			/* 170 = omsgsys */
#else
	{ 0, 0,
