...
struct Extended_Int
{
  ...
  Extended_Int (const Integer &param1, const Integer &param2, int param3);
  Extended_Int (const Extended_Int& param);
  Extended_Int (void) {}

  friend inline Extended_Int operator- (const Extended_Int &param1,
...
inline
Extended_Int::Extended_Int (const Integer &param1, const Integer &param2,
			    int param3)
{
  base  = param1;
  rad_5 = param2;
...
inline
Extended_Int::Extended_Int (const Extended_Int &param)
{
  base  = param.base;
  rad_5 = param.rad_5;
  pow_2 = param.pow_2;
...
inline Extended_Int 
operator- (const Extended_Int &param1, const Extended_Int &param2)
{
  Extended_Int temp;
...
inline Extended_Int 
sqrt (const Extended_Int &param1)
{
