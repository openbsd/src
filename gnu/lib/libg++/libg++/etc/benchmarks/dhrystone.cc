...
/* cfront 3.0 can't handle the assignments */
#ifndef __GNUG__
...
void Proc4();
void Proc5();
dhry_boolean Func3(Enumeration	EnumParIn);
...
dhry_boolean Func2(String30	StrParI1, String30	StrParI2);
dhry_boolean Func3(Enumeration	EnumParIn);
