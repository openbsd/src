...
regex_compile
	...
	.ENTRY
	stw %r2,-20(0,%r30) ;# 8989 reload_outsi+2/6
	ldo 320(%r30),%r30 ;# 8991 addsi3/2
	stw %r18,-168(0,%r30) ;# 8993 reload_outsi+2/6
	stw %r17,-164(0,%r30) ;# 8995 reload_outsi+2/6
	stw %r16,-160(0,%r30) ;# 8997 reload_outsi+2/6
	stw %r15,-156(0,%r30) ;# 8999 reload_outsi+2/6
	stw %r14,-152(0,%r30) ;# 9001 reload_outsi+2/6
	stw %r13,-148(0,%r30) ;# 9003 reload_outsi+2/6
	stw %r12,-144(0,%r30) ;# 9005 reload_outsi+2/6
	stw %r11,-140(0,%r30) ;# 9007 reload_outsi+2/6
	stw %r10,-136(0,%r30) ;# 9009 reload_outsi+2/6
	stw %r9,-132(0,%r30) ;# 9011 reload_outsi+2/6
	stw %r8,-128(0,%r30) ;# 9013 reload_outsi+2/6
	stw %r7,-124(0,%r30) ;# 9015 reload_outsi+2/6
	stw %r6,-120(0,%r30) ;# 9017 reload_outsi+2/6
	stw %r5,-116(0,%r30) ;# 9019 reload_outsi+2/6
	stw %r4,-112(0,%r30) ;# 9021 reload_outsi+2/6
	stw %r3,-108(0,%r30) ;# 9023 reload_outsi+2/6
	stw %r26,-276(0,%r30) ;# 4 reload_outsi+2/6
	ldi 0,%r9 ;# 25 reload_outsi+2/2
	ldi 0,%r8 ;# 28 reload_outsi+2/2
	stw 0,-260(0,%r30) ;# 34 reload_outsi+2/6
	ldi 0,%r10 ;# 31 reload_outsi+2/2
	ldi 640,%r26 ;# 37 reload_outsi+2/2
	ldw -276(0,%r30),%r1 ;# 8774 reload_outsi+2/5
	copy %r24,%r15 ;# 8 reload_outsi+2/1
	stw %r1,-296(0,%r30) ;# 2325 reload_outsi+2/6
	copy %r23,%r5 ;# 10 reload_outsi+2/1
	addl %r1,%r25,%r16 ;# 19 addsi3/1
	.CALL ARGW0=GR
	bl malloc,%r2 ;# 39 call_value_internal_symref
	ldw 20(0,%r5),%r14 ;# 22 reload_outsi+2/5
	comib,<> 0,%r28,L$0021 ;# 48 bleu+1
	stw %r28,-312(0,%r30) ;# 43 reload_outsi+2/6
L$0953
	bl L$0867,0 ;# 53 jump
	ldi 12,%r28 ;# 51 reload_outsi+2/2
L$0021
	ldi 32,%r19 ;# 58 reload_outsi+2/2
	stw %r19,-308(0,%r30) ;# 59 reload_outsi+2/6
	stw 0,-304(0,%r30) ;# 62 reload_outsi+2/6
	stw %r15,12(0,%r5) ;# 65 reload_outsi+2/6
	stw 0,8(0,%r5) ;# 85 reload_outsi+2/6
	stw 0,24(0,%r5) ;# 88 reload_outsi+2/6
	addil LR'done___2-$global$,%r27 ;# 92 pic2_lo_sum+1
	ldw 28(0,%r5),%r19 ;# 68 reload_outsi+2/5
	...
	stw %r19,28(0,%r5) ;# 82 reload_outsi+2/6
	...
	stbs,ma %r20,1(0,%r19) ;# 115 movqi+1/6
L$1155
	...
	stbs,ma %r21,1(0,%r20) ;# 138 movqi+1/6
L$1156
...
L$0037
	...
	stbs,ma %r21,1(0,%r19) ;# 161 movqi+1/6
	...
	stb %r20,95(0,%r19) ;# 177 movqi+1/6
...
L$0040
	...
	stw %r28,0(0,%r5) ;# 223 reload_outsi+2/6
L$1157
	ldw 0(0,%r5),%r19 ;# 228 reload_outsi+2/5
	comib,<> 0,%r19,L$0042 ;# 230 bleu+1
	ldi 32,%r19 ;# 243 reload_outsi+2/2
	.CALL ARGW0=GR
	bl free,%r2 ;# 234 call_internal_symref
	ldw -312(0,%r30),%r26 ;# 232 reload_outsi+2/5
	bl L$0867,0 ;# 238 jump
	ldi 12,%r28 ;# 51 reload_outsi+2/2
L$0042
	stw %r19,4(0,%r5) ;# 244 reload_outsi+2/6
L$0039
	ldw 0(0,%r5),%r6 ;# 249 reload_outsi+2/5
	ldw -296(0,%r30),%r19 ;# 7981 reload_outsi+2/5
	comclr,<> %r16,%r19,0 ;# 7982 bleu+1
	bl L$0044,0
	copy %r6,%r12 ;# 253 reload_outsi+2/1
	ldw -296(0,%r30),%r19 ;# 2334 reload_outsi+2/5
L$1178
	ldbs,ma 1(0,%r19),%r7 ;# 277 zero_extendqisi2/2
	comib,= 0,%r14,L$0047 ;# 282 bleu+1
	stw %r19,-296(0,%r30) ;# 2337 reload_outsi+2/6
	addl %r14,%r7,%r19 ;# 283 addsi3/1
	ldb 0(0,%r19),%r7 ;# 286 zero_extendqisi2/2
L$0047
	ldo -10(%r7),%r19 ;# 7895 addsi3/2
	addi,uv -115,%r19,0 ;# 7896 casesi0
	blr,n %r19,0
	b,n L$0076
L$0863
	bl L$0376,0
...
L$0979
	bl L$0077,0 ;# 9170 switch_jump
	ldw -296(0,%r30),%r26 ;# 2349 reload_outsi+2/5
L$0980
	bl L$0076,0
...
L$0989
	bl L$0196,0 ;# 9200 switch_jump
	ldw 0(0,%r5),%r4 ;# 8027 reload_outsi+2/5
L$0990
	bl L$0076,0
...
L$1034
	bl L$0216,0 ;# 9335 switch_jump
	ldw -296(0,%r30),%r19 ;# 2418 reload_outsi+2/5
L$1035
	bl L$0387,0 ;# 9338 switch_jump
	ldw -296(0,%r30),%r19 ;# 3797 reload_outsi+2/5
L$1036
	bl L$0076,0
	nop ;# 9341 switch_jump
L$1037
	bl L$0053,0 ;# 9344 switch_jump
	ldw -276(0,%r30),%r1 ;# 8777 reload_outsi+2/5
L$1038
	bl L$0076,0
...
L$0061
	comclr,<> %r3,%r20,0 ;# 357 bleu+1
	bl L$0944,0
	zdep %r20,30,31,%r19 ;# 367 ashlsi3+1
	comb,>>= %r3,%r19,L$0066 ;# 375 bleu+1
	stw %r19,4(0,%r5) ;# 369 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 378 reload_outsi+2/6
L$0066
	ldw 0(0,%r5),%r26 ;# 385 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 389 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 387 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 397 bleu+1
	stw %r28,0(0,%r5) ;# 393 reload_outsi+2/6
...
L$0059
	ldw 0(0,%r5),%r4 ;# 337 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 341 reload_outsi+2/5
...
L$0060
	...
	bl L$0043,0 ;# 479 jump
	stbs,ma %r19,1(0,%r6) ;# 459 movqi+1/6
L$0077
	...
	comiclr,<> 0,%r28,0 ;# 503 bleu+1
	bl,n L$0076,0
L$0079
	ldw 0(0,%r5),%r4 ;# 7994 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 7997 reload_outsi+2/5
...
L$0085
	comclr,<> %r3,%r20,0 ;# 534 bleu+1
	bl L$0944,0
	zdep %r20,30,31,%r19 ;# 544 ashlsi3+1
	comb,>>= %r3,%r19,L$0090 ;# 552 bleu+1
	stw %r19,4(0,%r5) ;# 546 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 555 reload_outsi+2/6
L$0090
	ldw 0(0,%r5),%r26 ;# 562 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 566 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 564 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 574 bleu+1
	stw %r28,0(0,%r5) ;# 570 reload_outsi+2/6
...
L$0083
	ldw 0(0,%r5),%r4 ;# 514 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 518 reload_outsi+2/5
...
L$0084
	...
	bl L$0043,0 ;# 656 jump
	stbs,ma %r19,1(0,%r6) ;# 636 movqi+1/6
L$0877
	bl L$0110,0 ;# 897 jump
	stw %r21,-296(0,%r30) ;# 2391 reload_outsi+2/6
L$0101
L$1158
	and %r15,%r19,%r19 ;# 663 andsi3/1
	comiclr,= 0,%r19,0 ;# 665 bleu+1
	bl,n L$0076,0
L$0104
	comib,<> 0,%r8,L$0105 ;# 674 bleu+1
	ldi 0,%r13 ;# 711 reload_outsi+2/2
	extrs,>= %r15,26,1,0 ;# 681 bleu+3
	extrs,< %r15,27,1,0 ;# 700 movsi-4
	nop
	bl,n L$0076,0
L$0105
...
L$0118
	...
	ldw -296(0,%r30),%r19 ;# 2400 reload_outsi+2/5
	bl,n L$1160,0 ;# 827 jump
L$0869
	comb,<> %r26,%r7,L$0126 ;# 831 bleu+1
	ldw -296(0,%r30),%r19 ;# 2400 reload_outsi+2/5
	comclr,<> %r16,%r20,0 ;# 835 bleu+1
	bl L$0903,0
	ldo 1(%r20),%r19 ;# 863 addsi3/2
	ldb 1(0,%r21),%r3 ;# 860 zero_extendqisi2/2
	comib,= 0,%r14,L$0129 ;# 865 bleu+1
	stw %r19,-296(0,%r30) ;# 2379 reload_outsi+2/6
	addl %r14,%r3,%r19 ;# 866 addsi3/1
	ldb 0(0,%r19),%r3 ;# 869 zero_extendqisi2/2
L$0129
	comb,= %r24,%r3,L$0109 ;# 886 bleu+1
	copy %r3,%r7 ;# 903 reload_outsi+2/1
	comb,<> %r23,%r3,L$0877
	nop ;# 890 bleu+1
	bl,n L$0109,0 ;# 905 jump
L$0126
L$1160
	ldo -1(%r19),%r19 ;# 910 addsi3/2
	stw %r19,-296(0,%r30) ;# 2397 reload_outsi+2/6
L$0110
	comiclr,<> 0,%r8,0 ;# 927 bleu+1
	bl L$1161,0
	ldw -296(0,%r30),%r19 ;# 2328 reload_outsi+2/5
	comib,=,n 0,%r22,L$0137 ;# 934 bleu+1
	ldw 0(0,%r5),%r3 ;# 8002 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8005 reload_outsi+2/5
...
L$0140
	comclr,<> %r4,%r20,0 ;# 961 bleu+1
	bl L$0944,0
	zdep %r20,30,31,%r19 ;# 971 ashlsi3+1
	comb,>>= %r4,%r19,L$0145 ;# 979 bleu+1
	stw %r19,4(0,%r5) ;# 973 reload_outsi+2/6
	stw %r4,4(0,%r5) ;# 982 reload_outsi+2/6
L$0145
	ldw 0(0,%r5),%r26 ;# 989 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 993 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 991 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 1001 bleu+1
	stw %r28,0(0,%r5) ;# 997 reload_outsi+2/6
...
L$0138
	ldw 0(0,%r5),%r3 ;# 941 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 945 reload_outsi+2/5
...
L$0139
	...
	ldw -296(0,%r30),%r19 ;# 2403 reload_outsi+2/5
	ldb -2(0,%r19),%r19 ;# 1066 zero_extendqisi2/2
	addl %r14,%r19,%r19 ;# 1067 addsi3/1
	bl L$0947,0 ;# 1071 jump
	ldb 0(0,%r19),%r19 ;# 1069 movqi+1/5
L$0154
	ldb -2(0,%r19),%r19 ;# 1075 movqi+1/5
L$0947
	comib,= 0,%r14,L$0156 ;# 1079 bleu+1
	extrs %r19,31,8,%r20 ;# 1076 extendqisi2
	ldb 46(0,%r14),%r19 ;# 1081 movqi+1/5
	extrs %r19,31,8,%r19 ;# 1082 extendqisi2
	comb,= %r19,%r20,L$0157 ;# 1084 bleu+1
	ldi 17,%r26 ;# 1159 reload_outsi+2/2
	bl,n L$1162,0 ;# 1085 jump
L$0156
...
L$0137
	ldw 0(0,%r5),%r3 ;# 8010 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8013 reload_outsi+2/5
...
L$0165
	comclr,<> %r4,%r20,0 ;# 1195 bleu+1
	bl L$0944,0
	zdep %r20,30,31,%r19 ;# 1205 ashlsi3+1
	comb,>>= %r4,%r19,L$0170 ;# 1213 bleu+1
	stw %r19,4(0,%r5) ;# 1207 reload_outsi+2/6
	stw %r4,4(0,%r5) ;# 1216 reload_outsi+2/6
L$0170
	ldw 0(0,%r5),%r26 ;# 1223 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 1227 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 1225 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 1235 bleu+1
	stw %r28,0(0,%r5) ;# 1231 reload_outsi+2/6
...
L$0163
	ldw 0(0,%r5),%r3 ;# 1175 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 1179 reload_outsi+2/5
...
L$0164
	...
	ldw 0(0,%r5),%r3 ;# 8019 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8022 reload_outsi+2/5
...
L$0183
	...
	stw %r19,4(0,%r5) ;# 1364 reload_outsi+2/6
	stw %r4,4(0,%r5) ;# 1373 reload_outsi+2/6
L$0188
	ldw 0(0,%r5),%r26 ;# 1380 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 1384 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 1382 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 1392 bleu+1
	stw %r28,0(0,%r5) ;# 1388 reload_outsi+2/6
...
L$0181
	ldw 0(0,%r5),%r3 ;# 1332 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 1336 reload_outsi+2/5
...
L$0182
	...
	bl L$0043,0 ;# 1470 jump
	ldo 3(%r6),%r6 ;# 1464 addsi3/2
L$0196
	ldw 4(0,%r5),%r20 ;# 8030 reload_outsi+2/5
...
L$0202
	...
	stw %r19,4(0,%r5) ;# 1515 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 1524 reload_outsi+2/6
L$0207
	ldw 0(0,%r5),%r26 ;# 1531 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 1535 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 1533 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 1543 bleu+1
	stw %r28,0(0,%r5) ;# 1539 reload_outsi+2/6
...
L$0200
	ldw 0(0,%r5),%r4 ;# 1483 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 1487 reload_outsi+2/5
...
L$0201
	...
	bl L$0043,0 ;# 1617 jump
	stbs,ma %r19,1(0,%r6) ;# 1605 movqi+1/6
L$0216
	comb,= %r16,%r19,L$0902 ;# 1626 bleu+1
	ldi 0,%r13 ;# 1623 reload_outsi+2/2
	ldw 0(0,%r5),%r3 ;# 8035 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8038 reload_outsi+2/5
...
L$0220
	...
	stw %r19,4(0,%r5) ;# 1673 reload_outsi+2/6
	stw %r4,4(0,%r5) ;# 1682 reload_outsi+2/6
L$0225
	ldw 0(0,%r5),%r26 ;# 1689 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 1693 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 1691 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 1701 bleu+1
	stw %r28,0(0,%r5) ;# 1697 reload_outsi+2/6
...
L$0218
	ldw 0(0,%r5),%r3 ;# 1641 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 1645 reload_outsi+2/5
	sub %r6,%r3,%r19 ;# 1642 subsi3/1
	ldo 34(%r19),%r19 ;# 1643 addsi3/2
	comb,<< %r20,%r19,L$0220
	nop ;# 1647 bleu+1
L$0219
	ldw 0(0,%r5),%r4 ;# 8043 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8046 reload_outsi+2/5
...
L$0238
	...
	stw %r19,4(0,%r5) ;# 1803 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 1812 reload_outsi+2/6
L$0243
	ldw 0(0,%r5),%r26 ;# 1819 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 1823 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 1821 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 1831 bleu+1
	stw %r28,0(0,%r5) ;# 1827 reload_outsi+2/6
...
L$0236
	ldw 0(0,%r5),%r4 ;# 1771 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 1775 reload_outsi+2/5
...
L$0237
	...
	ldw -296(0,%r30),%r19 ;# 2421 reload_outsi+2/5
	ldb 0(0,%r19),%r19 ;# 1893 movqi+1/5
...
L$0251
	stb %r20,0(0,%r22) ;# 1911 movqi+1/6
	ldw -296(0,%r30),%r20 ;# 2424 reload_outsi+2/5
	ldb 0(0,%r20),%r19 ;# 1923 movqi+1/5
	extrs %r19,31,8,%r19 ;# 1924 extendqisi2
	comb,<> %r21,%r19,L$0254 ;# 1928 bleu+1
	ldo 1(%r20),%r19 ;# 1930 addsi3/2
	stw %r19,-296(0,%r30) ;# 2427 reload_outsi+2/6
L$0254
	ldw 0(0,%r5),%r4 ;# 8052 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8055 reload_outsi+2/5
	ldw -296(0,%r30),%r1 ;# 2433 reload_outsi+2/5
	sub %r6,%r4,%r19 ;# 8053 subsi3/1
	ldo 1(%r19),%r19 ;# 8054 addsi3/2
	comb,>>= %r20,%r19,L$0259 ;# 8056 bleu+1
	stw %r1,-268(0,%r30) ;# 8789 reload_outsi+2/6
...
L$0260
	...
	stw %r19,4(0,%r5) ;# 1974 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 1983 reload_outsi+2/6
L$0265
	ldw 0(0,%r5),%r26 ;# 1990 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 1994 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 1992 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 2002 bleu+1
	stw %r28,0(0,%r5) ;# 1998 reload_outsi+2/6
...
L$0258
	ldw 0(0,%r5),%r4 ;# 1942 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 1946 reload_outsi+2/5
...
L$0259
	...
	stbs,ma %r19,1(0,%r6) ;# 2064 movqi+1/6
...
L$0280
	...
	ldb 1(0,%r20),%r3 ;# 2192 zero_extendqisi2/2
	comib,= 0,%r14,L$0288 ;# 2197 bleu+1
	stw %r19,-296(0,%r30) ;# 2460 reload_outsi+2/6
	addl %r14,%r3,%r19 ;# 2198 addsi3/1
	ldb 0(0,%r19),%r3 ;# 2201 zero_extendqisi2/2
L$0288
	extru %r3,28,29,%r19 ;# 2216 lshrsi3/2
	addl %r6,%r19,%r19 ;# 2219 addsi3/1
	bl L$0948,0 ;# 2235 jump
	extru %r3,31,3,%r20 ;# 2222 andsi3/1
L$0285
	comb,<>,n %r17,%r7,L$0293 ;# 2243 bleu+1
	ldw -268(0,%r30),%r1 ;# 8798 reload_outsi+2/5
	ldw -296(0,%r30),%r20 ;# 2466 reload_outsi+2/5
...
L$0293
	...
	ldw -296(0,%r30),%r20 ;# 2524 reload_outsi+2/5
	ldw -296(0,%r30),%r19 ;# 2469 reload_outsi+2/5
	ldb 0(0,%r19),%r19 ;# 2259 movqi+1/5
...
L$1163
	...
	stw %r19,-296(0,%r30) ;# 2561 reload_outsi+2/6
L$0302
	stw %r6,-52(0,%r30) ;# 2588 reload_outsi+2/6
	...
	ldw -312(0,%r30),%r26 ;# 2605 reload_outsi+2/5
	bl L$0867,0 ;# 2611 jump
	copy %r4,%r28 ;# 2609 reload_outsi+2/1
L$0300
	ldw -252(0,%r30),%r1 ;# 8822 reload_outsi+2/5
	comib,= 0,%r1,L$0309 ;# 2624 bleu+1
	ldi 91,%r1 ;# 8825 reload_outsi+2/2
	comb,<> %r1,%r7,L$1166 ;# 2628 bleu+1
	ldi 0,%r13 ;# 3624 reload_outsi+2/2
	ldw -296(0,%r30),%r20 ;# 2630 reload_outsi+2/5
	ldb 0(0,%r20),%r19 ;# 2632 movqi+1/5
	...
	stw %r19,-296(0,%r30) ;# 2658 reload_outsi+2/6
	comb,= %r16,%r19,L$0902 ;# 2689 bleu+1
	ldi 0,%r3 ;# 2684 reload_outsi+2/2
L$0317
	ldw -296(0,%r30),%r19 ;# 2709 reload_outsi+2/5
	comb,= %r16,%r19,L$0922 ;# 2711 bleu+1
	ldo 1(%r19),%r20 ;# 2720 addsi3/2
	stw %r20,-296(0,%r30) ;# 2722 reload_outsi+2/6
	comib,= 0,%r14,L$0321 ;# 2729 bleu+1
	ldb 0(0,%r19),%r7 ;# 2725 zero_extendqisi2/2
	addl %r14,%r7,%r19 ;# 2730 addsi3/1
	ldb 0(0,%r19),%r7 ;# 2733 zero_extendqisi2/2
L$0321
	...
	bl L$0317,0 ;# 2783 jump
	stb %r7,0(0,%r20) ;# 2778 movqi+1/6
L$1167
	comb,<> %r1,%r7,L$0328 ;# 2796 bleu+1
	stb 0,0(0,%r19) ;# 2791 movqi+1/6
	ldw -296(0,%r30),%r19 ;# 2798 reload_outsi+2/5
	ldb 0(0,%r19),%r19 ;# 2800 movqi+1/5
	...
	stw %r28,-244(0,%r30) ;# 8841 reload_outsi+2/6
	...
	stw %r28,-236(0,%r30) ;# 8846 reload_outsi+2/6
	...
	stw %r28,-228(0,%r30) ;# 8851 reload_outsi+2/6
	...
	stw %r28,-220(0,%r30) ;# 8856 reload_outsi+2/6
	...
	stw %r28,-212(0,%r30) ;# 8861 reload_outsi+2/6
	...
	stw %r28,-204(0,%r30) ;# 8866 reload_outsi+2/6
	...
	stw %r28,-196(0,%r30) ;# 8871 reload_outsi+2/6
	...
	stw %r28,-188(0,%r30) ;# 8876 reload_outsi+2/6
	...
	stw %r28,-180(0,%r30) ;# 8881 reload_outsi+2/6
	...
	stw %r28,-172(0,%r30) ;# 8884 reload_outsi+2/6
...
L$0329
	...
	ldw -244(0,%r30),%r1 ;# 8916 reload_outsi+2/5
L$1173
	...
	ldb 0(0,%r19),%r20 ;# 3255 movqi+1/5
	ldb 0(0,%r21),%r19 ;# 3267 movqi+1/5
...
L$0354
	...
	ldb 0(0,%r19),%r19 ;# 3493 movqi+1/5
...
L$0355
	...
	ldb 0(0,%r19),%r19 ;# 3509 movqi+1/5
...
L$0360
	...
	ldw -296(0,%r30),%r19 ;# 3583 reload_outsi+2/5
	extru %r20,31,8,%r3 ;# 3572 zero_extendqisi2/1
	ldo -1(%r19),%r19 ;# 3584 addsi3/2
	comb,<> %r21,%r3,L$0360 ;# 3577 bleu+1
	stw %r19,-296(0,%r30) ;# 3588 reload_outsi+2/6
L$0359
	ldb 11(0,%r6),%r19 ;# 3599 movqi+1/5
	depi -1,28,1,%r19 ;# 3601 iorsi3+1/2
	stb %r19,11(0,%r6) ;# 3603 movqi+1/6
	ldb 7(0,%r6),%r19 ;# 3606 movqi+1/5
	ldi 0,%r13 ;# 3613 reload_outsi+2/2
	depi -1,29,1,%r19 ;# 3608 iorsi3+1/2
	bl L$0275,0 ;# 3618 jump
	stb %r19,7(0,%r6) ;# 3610 movqi+1/6
L$0309
	ldi 0,%r13 ;# 3624 reload_outsi+2/2
L$1166
...
L$1183
	...
	ldb -1(0,%r19),%r19 ;# 3672 zero_extendqisi2/2
	comib,=,n 0,%r19,L$0365 ;# 3674 bleu+1
	ldb -1(0,%r6),%r19 ;# 3683 movqi+1/5
L$0364
	ldb -1(0,%r6),%r19 ;# 3700 zero_extendqisi2/2
	bl L$0043,0 ;# 3705 jump
	addl %r6,%r19,%r6 ;# 3701 addsi3/1
L$0368
	bb,>=,n %r15,18,L$0076 ;# 3713 movsi-4
	bl L$1181,0 ;# 3721 jump
	ldw 24(0,%r5),%r19 ;# 3861 reload_outsi+2/5
L$0372
	bb,>=,n %r15,18,L$0076 ;# 3730 movsi-4
	bl,n L$0374,0 ;# 3738 jump
L$0376
	bb,>=,n %r15,20,L$0076 ;# 3747 movsi-4
	bl,n L$0378,0 ;# 3755 jump
L$0380
	bb,>=,n %r15,16,L$0076 ;# 3764 movsi-4
	bl,n L$0378,0 ;# 3772 jump
L$0383
	and %r15,%r20,%r19 ;# 3779 andsi3/1
	comb,= %r20,%r19,L$1174 ;# 3783 bleu+1
	ldi -1,%r4 ;# 5074 reload_outsi+2/2
	bl,n L$0076,0 ;# 3791 jump
L$0387
	comb,=,n %r16,%r19,L$0903 ;# 3799 bleu+1
	ldb 0(0,%r19),%r7 ;# 3831 zero_extendqisi2/2
	ldo 1(%r19),%r19 ;# 3826 addsi3/2
	stw %r19,-296(0,%r30) ;# 3828 reload_outsi+2/6
	ldo -39(%r7),%r19 ;# 7446 addsi3/2
	addi,uv -86,%r19,0 ;# 7447 casesi0
	blr,n %r19,0
	b,n L$0397
L$0817
	bl L$0759,0 ;# 9437 switch_jump
	ldw 0(0,%r5),%r4 ;# 8204 reload_outsi+2/5
L$1069
	bl L$0395,0
...
L$1089
	bl L$0659,0 ;# 9500 switch_jump
	ldw 0(0,%r5),%r4 ;# 8164 reload_outsi+2/5
L$1090
	bl L$0397,0
	nop ;# 9503 switch_jump
L$1091
	bl L$0679,0 ;# 9506 switch_jump
	ldw 0(0,%r5),%r4 ;# 8172 reload_outsi+2/5
L$1092
	bl L$0811,0
...
L$1095
	bl L$0719,0 ;# 9518 switch_jump
	ldw 0(0,%r5),%r4 ;# 8188 reload_outsi+2/5
L$1096
	bl L$0397,0
...
L$1116
	bl L$0639,0 ;# 9581 switch_jump
	ldw 0(0,%r5),%r4 ;# 8156 reload_outsi+2/5
L$1117
	bl L$0397,0
...
L$1125
	bl L$0739,0 ;# 9608 switch_jump
	ldw 0(0,%r5),%r4 ;# 8196 reload_outsi+2/5
L$1126
	bl L$0397,0
	nop ;# 9611 switch_jump
L$1127
	bl L$0699,0 ;# 9614 switch_jump
	ldw 0(0,%r5),%r4 ;# 8180 reload_outsi+2/5
L$1128
	bl L$0397,0
...
L$1148
	bl L$0619,0 ;# 9677 switch_jump
	ldw 0(0,%r5),%r4 ;# 8148 reload_outsi+2/5
L$1149
	bl L$0397,0
...
L$1153
	bl L$0472,0 ;# 9692 switch_jump
	ldil L'33792,%r19 ;# 4724 add_high_const+3
L$1154
	bl,n L$0397,0 ;# 7450 jump
L$0395
	bb,<,n %r15,18,L$0397 ;# 3853 bleu+3
	ldw 24(0,%r5),%r19 ;# 3861 reload_outsi+2/5
L$1181
	ldo 1(%r19),%r19 ;# 3862 addsi3/2
	stw %r19,24(0,%r5) ;# 3866 reload_outsi+2/6
	ldw -304(0,%r30),%r20 ;# 3871 reload_outsi+2/5
	ldw -260(0,%r30),%r1 ;# 8958 reload_outsi+2/5
	ldw -308(0,%r30),%r19 ;# 3873 reload_outsi+2/5
	ldo 1(%r1),%r1 ;# 3868 addsi3/2
	comb,<> %r19,%r20,L$0398 ;# 3875 bleu+1
	stw %r1,-260(0,%r30) ;# 8961 reload_outsi+2/6
	zdep %r20,28,29,%r25 ;# 3885 ashlsi3+1
	sh1addl %r20,%r25,%r25 ;# 3886 ashlsi3-2
	ldw -312(0,%r30),%r26 ;# 3890 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 3894 call_value_internal_symref
	zdep %r25,29,30,%r25 ;# 3892 ashlsi3+1
	comib,= 0,%r28,L$0953 ;# 3903 bleu+1
	stw %r28,-312(0,%r30) ;# 3898 reload_outsi+2/6
	ldw -308(0,%r30),%r19 ;# 3912 reload_outsi+2/5
	zdep %r19,30,31,%r19 ;# 3914 ashlsi3+1
	stw %r19,-308(0,%r30) ;# 3916 reload_outsi+2/6
L$0398
	ldw -304(0,%r30),%r20 ;# 3921 reload_outsi+2/5
	ldw -312(0,%r30),%r21 ;# 3923 reload_outsi+2/5
	ldw 0(0,%r5),%r19 ;# 3933 reload_outsi+2/5
	sh2addl %r20,%r20,%r20 ;# 3928 ashlsi3-2
	sh2addl %r20,%r21,%r21 ;# 3931 ashlsi3-2
	sub %r12,%r19,%r19 ;# 3934 subsi3/1
	stw %r19,0(0,%r21) ;# 3936 reload_outsi+2/6
	ldw -304(0,%r30),%r19 ;# 3939 reload_outsi+2/5
	ldw -312(0,%r30),%r20 ;# 3941 reload_outsi+2/5
	sh2addl %r19,%r19,%r19 ;# 3946 ashlsi3-2
	comib,= 0,%r10,L$0400 ;# 3951 bleu+1
	sh2addl %r19,%r20,%r20 ;# 3949 ashlsi3-2
	ldw 0(0,%r5),%r19 ;# 3953 reload_outsi+2/5
	sub %r10,%r19,%r19 ;# 3954 subsi3/1
	ldo 1(%r19),%r19 ;# 3955 addsi3/2
	bl L$0401,0 ;# 3958 jump
	stw %r19,4(0,%r20) ;# 3957 reload_outsi+2/6
L$0400
	stw 0,4(0,%r20) ;# 3962 reload_outsi+2/6
L$0401
	ldw -304(0,%r30),%r20 ;# 3966 reload_outsi+2/5
	ldw -312(0,%r30),%r21 ;# 3968 reload_outsi+2/5
	ldw 0(0,%r5),%r19 ;# 3978 reload_outsi+2/5
	sh2addl %r20,%r20,%r20 ;# 3973 ashlsi3-2
	sh2addl %r20,%r21,%r21 ;# 3976 ashlsi3-2
	sub %r6,%r19,%r19 ;# 3979 subsi3/1
	stw %r19,12(0,%r21) ;# 3981 reload_outsi+2/6
	ldw -304(0,%r30),%r19 ;# 3984 reload_outsi+2/5
	ldw -312(0,%r30),%r20 ;# 3986 reload_outsi+2/5
	ldw -260(0,%r30),%r1 ;# 8964 reload_outsi+2/5
	...
	stw %r1,16(0,%r20) ;# 3996 reload_outsi+2/6
	ldw -304(0,%r30),%r20 ;# 4005 reload_outsi+2/5
	ldw -312(0,%r30),%r21 ;# 4007 reload_outsi+2/5
	ldw 0(0,%r5),%r19 ;# 4017 reload_outsi+2/5
	...
	stw %r19,8(0,%r21) ;# 4021 reload_outsi+2/6
	ldw 0(0,%r5),%r4 ;# 8087 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8090 reload_outsi+2/5
...
L$0408
	...
	stw %r19,4(0,%r5) ;# 4061 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 4070 reload_outsi+2/6
L$0413
	ldw 0(0,%r5),%r26 ;# 4077 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 4081 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 4079 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 4089 bleu+1
	stw %r28,0(0,%r5) ;# 4085 reload_outsi+2/6
...
L$0406
	ldw 0(0,%r5),%r4 ;# 4029 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 4033 reload_outsi+2/5
...
L$0407
	...
	stbs,ma %r19,1(0,%r6) ;# 4151 movqi+1/6
	ldb -257(0,%r30),%r1 ;# 4156 movqi+1/5
	stbs,ma %r1,1(0,%r6) ;# 8968 movqi+1/6
	stbs,ma 0,1(0,%r6) ;# 4159 movqi+1/6
L$0402
	ldi 0,%r10 ;# 4182 reload_outsi+2/2
	ldi 0,%r8 ;# 4185 reload_outsi+2/2
	copy %r6,%r12 ;# 4188 reload_outsi+2/1
	ldw -304(0,%r30),%r19 ;# 4174 reload_outsi+2/5
	ldi 0,%r9 ;# 4191 reload_outsi+2/2
	ldo 1(%r19),%r19 ;# 4175 addsi3/2
	bl L$0043,0 ;# 4193 jump
	stw %r19,-304(0,%r30) ;# 4179 reload_outsi+2/6
L$0422
	bb,< %r15,18,L$0397 ;# 4201 bleu+3
	ldw -304(0,%r30),%r19 ;# 4207 reload_outsi+2/5
	comib,<>,n 0,%r19,L$0374 ;# 4209 bleu+1
	bb,>=,n %r15,14,L$0950 ;# 4215 movsi-4
	bl,n L$0397,0 ;# 4230 jump
L$0374
	comib,=,n 0,%r10,L$0427 ;# 4237 bleu+1
	ldw 0(0,%r5),%r4 ;# 8095 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8098 reload_outsi+2/5
...
L$0433
	...
	stw %r19,4(0,%r5) ;# 4278 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 4287 reload_outsi+2/6
L$0438
	ldw 0(0,%r5),%r26 ;# 4294 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 4298 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 4296 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 4306 bleu+1
	stw %r28,0(0,%r5) ;# 4302 reload_outsi+2/6
...
L$0431
	ldw 0(0,%r5),%r4 ;# 4246 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 4250 reload_outsi+2/5
...
L$0432
	...
	stbs,ma %r19,1(0,%r6) ;# 4368 movqi+1/6
...
L$0427
	ldw -304(0,%r30),%r19 ;# 4395 reload_outsi+2/5
	comib,<>,n 0,%r19,L$0447 ;# 4397 bleu+1
	bb,<,n %r15,14,L$0076 ;# 4403 bleu+3
L$0950
	.CALL ARGW0=GR
	bl free,%r2 ;# 4414 call_internal_symref
	ldw -312(0,%r30),%r26 ;# 4412 reload_outsi+2/5
	bl L$0867,0 ;# 4418 jump
	ldi 16,%r28 ;# 4416 reload_outsi+2/2
L$0447
	ldo -1(%r19),%r19 ;# 4427 addsi3/2
	stw %r19,-304(0,%r30) ;# 4431 reload_outsi+2/6
	ldw -312(0,%r30),%r20 ;# 4436 reload_outsi+2/5
	sh2addl %r19,%r19,%r19 ;# 4441 ashlsi3-2
	sh2addl %r19,%r20,%r20 ;# 4444 ashlsi3-2
	ldw 0(0,%r5),%r21 ;# 4446 reload_outsi+2/5
	ldw 0(0,%r20),%r19 ;# 4448 reload_outsi+2/5
	ldw 4(0,%r20),%r20 ;# 4464 reload_outsi+2/5
	comib,= 0,%r20,L$0450 ;# 4466 bleu+1
	addl %r21,%r19,%r12 ;# 4449 addsi3/1
	addl %r21,%r20,%r19 ;# 4483 addsi3/1
	bl L$0451,0 ;# 4485 jump
	ldo -1(%r19),%r10 ;# 4484 addsi3/2
L$0450
	ldi 0,%r10 ;# 4489 reload_outsi+2/2
L$0451
	ldw -304(0,%r30),%r19 ;# 4493 reload_outsi+2/5
	ldw -312(0,%r30),%r20 ;# 4495 reload_outsi+2/5
	ldw 0(0,%r5),%r21 ;# 4505 reload_outsi+2/5
	sh2addl %r19,%r19,%r19 ;# 4500 ashlsi3-2
	sh2addl %r19,%r20,%r20 ;# 4503 ashlsi3-2
	ldw 12(0,%r20),%r19 ;# 4507 reload_outsi+2/5
	ldw 16(0,%r20),%r7 ;# 4523 reload_outsi+2/5
	...
	ldw 8(0,%r20),%r19 ;# 4550 reload_outsi+2/5
	ldw -260(0,%r30),%r1 ;# 8971 reload_outsi+2/5
	addl %r21,%r19,%r19 ;# 4551 addsi3/1
	sub %r1,%r7,%r20 ;# 4557 subsi3/1
	stb %r20,0(0,%r19) ;# 4559 movqi+1/6
	ldw 0(0,%r5),%r4 ;# 8103 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8106 reload_outsi+2/5
...
L$0458
	...
	stw %r19,4(0,%r5) ;# 4599 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 4608 reload_outsi+2/6
L$0463
	ldw 0(0,%r5),%r26 ;# 4615 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 4619 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 4617 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 4627 bleu+1
	stw %r28,0(0,%r5) ;# 4623 reload_outsi+2/6
...
L$0456
	ldw 0(0,%r5),%r4 ;# 4567 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 4571 reload_outsi+2/5
...
L$0457
	...
	stbs,ma %r19,1(0,%r6) ;# 4689 movqi+1/6
	stbs,ma %r7,1(0,%r6) ;# 4694 movqi+1/6
	ldw -260(0,%r30),%r1 ;# 8974 reload_outsi+2/5
	sub %r1,%r7,%r19 ;# 4700 subsi3/1
	bl L$0043,0 ;# 4720 jump
	stbs,ma %r19,1(0,%r6) ;# 4702 movqi+1/6
L$0472
...
L$0378
	...
	ldw 0(0,%r5),%r3 ;# 8111 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8114 reload_outsi+2/5
...
L$0477
	...
	stw %r19,4(0,%r5) ;# 4780 reload_outsi+2/6
	stw %r4,4(0,%r5) ;# 4789 reload_outsi+2/6
L$0482
	ldw 0(0,%r5),%r26 ;# 4796 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 4800 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 4798 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 4808 bleu+1
	stw %r28,0(0,%r5) ;# 4804 reload_outsi+2/6
...
L$0475
	ldw 0(0,%r5),%r3 ;# 4748 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 4752 reload_outsi+2/5
...
L$0490
	ldw 0(0,%r5),%r3 ;# 8119 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8122 reload_outsi+2/5
...
L$0493
	...
	stw %r19,4(0,%r5) ;# 4941 reload_outsi+2/6
	stw %r4,4(0,%r5) ;# 4950 reload_outsi+2/6
L$0498
	ldw 0(0,%r5),%r26 ;# 4957 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 4961 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 4959 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 4969 bleu+1
	stw %r28,0(0,%r5) ;# 4965 reload_outsi+2/6
...
L$0491
	ldw 0(0,%r5),%r3 ;# 4909 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 4913 reload_outsi+2/5
...
L$0506
	...
	ldw -296(0,%r30),%r20 ;# 5055 reload_outsi+2/5
	ldw -276(0,%r30),%r1 ;# 8977 reload_outsi+2/5
	ldo -2(%r20),%r19 ;# 5056 addsi3/2
	comb,<> %r1,%r19,L$1175 ;# 5058 bleu+1
	ldi -1,%r4 ;# 5074 reload_outsi+2/2
	comb,=,n %r16,%r20,L$0397 ;# 5062 bleu+1
L$1174
	ldw -296(0,%r30),%r20 ;# 5079 reload_outsi+2/5
L$1175
	...
	bl L$1182,0 ;# 5107 jump
	stw %r23,-296(0,%r30) ;# 5968 reload_outsi+2/6
L$0517
	ldo 1(%r20),%r19 ;# 5134 addsi3/2
	stw %r19,-296(0,%r30) ;# 5136 reload_outsi+2/6
	comib,= 0,%r14,L$0515 ;# 5143 bleu+1
	ldb 0(0,%r20),%r7 ;# 5139 zero_extendqisi2/2
	addl %r14,%r7,%r19 ;# 5144 addsi3/1
	ldb 0(0,%r19),%r7 ;# 5147 zero_extendqisi2/2
L$0515
...
L$0513
	...
	ldw -296(0,%r30),%r20 ;# 5259 reload_outsi+2/5
	comb,= %r16,%r20,L$0533 ;# 5261 bleu+1
	ldo 1(%r20),%r19 ;# 5278 addsi3/2
	stw %r19,-296(0,%r30) ;# 5280 reload_outsi+2/6
	comib,= 0,%r14,L$0535 ;# 5287 bleu+1
	ldb 0(0,%r20),%r7 ;# 5283 zero_extendqisi2/2
	addl %r14,%r7,%r19 ;# 5288 addsi3/1
	ldb 0(0,%r19),%r7 ;# 5291 zero_extendqisi2/2
L$0535
...
L$0553
	...
	ldw -296(0,%r30),%r20 ;# 5473 reload_outsi+2/5
	comb,= %r16,%r20,L$0922 ;# 5475 bleu+1
	ldo 1(%r20),%r19 ;# 5484 addsi3/2
	stw %r19,-296(0,%r30) ;# 5486 reload_outsi+2/6
	comib,= 0,%r14,L$0558 ;# 5493 bleu+1
	ldb 0(0,%r20),%r7 ;# 5489 zero_extendqisi2/2
	addl %r14,%r7,%r19 ;# 5494 addsi3/1
	ldb 0(0,%r19),%r7 ;# 5497 zero_extendqisi2/2
L$0558
	ldi 125,%r19 ;# 5514 reload_outsi+2/2
L$1176
...
L$0951
	...
	ldw -312(0,%r30),%r26 ;# 5532 reload_outsi+2/5
	bl L$0867,0 ;# 5538 jump
...
L$0569
	...
	ldw 0(0,%r5),%r3 ;# 8139 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8142 reload_outsi+2/5
...
L$0577
	...
	stw %r19,4(0,%r5) ;# 5625 reload_outsi+2/6
	stw %r4,4(0,%r5) ;# 5634 reload_outsi+2/6
L$0582
	ldw 0(0,%r5),%r26 ;# 5641 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 5645 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 5643 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 5653 bleu+1
	stw %r28,0(0,%r5) ;# 5649 reload_outsi+2/6
...
L$0575
	ldw 0(0,%r5),%r3 ;# 5593 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 5597 reload_outsi+2/5
...
L$0576
	...
	bl L$0590,0 ;# 5730 jump
	ldo 3(%r6),%r6 ;# 5728 addsi3/2
L$0574
	comiclr,> 2,%r4,0 ;# 8282 beq-1/2
	ldi 20,%r13
	ldw 0(0,%r5),%r3 ;# 8285 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8288 reload_outsi+2/5
...
L$0595
	...
	stw %r19,4(0,%r5) ;# 5781 reload_outsi+2/6
	stw %r7,4(0,%r5) ;# 5790 reload_outsi+2/6
L$0600
	ldw 0(0,%r5),%r26 ;# 5797 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 5801 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 5799 reload_outsi+2/5
	comib,= 0,%r28,L$0953 ;# 5809 bleu+1
	stw %r28,0(0,%r5) ;# 5805 reload_outsi+2/6
...
L$0593
	ldw 0(0,%r5),%r3 ;# 5749 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 5753 reload_outsi+2/5
...
L$0609
	...
	stw %r6,-52(0,%r30) ;# 5883 reload_outsi+2/6
	...
	stw %r6,-52(0,%r30) ;# 5898 reload_outsi+2/6
	...
	stw %r6,-52(0,%r30) ;# 5936 reload_outsi+2/6
...
L$0612
	...
	bl,n L$0076,0 ;# 6042 jump
L$0619
	ldw 4(0,%r5),%r20 ;# 8151 reload_outsi+2/5
...
L$0625
	...
	stw %r19,4(0,%r5) ;# 6087 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 6096 reload_outsi+2/6
L$0630
	ldw 0(0,%r5),%r26 ;# 6103 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 6107 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 6105 reload_outsi+2/5
	comiclr,<> 0,%r28,0 ;# 6115 bleu+1
	bl L$0953,0
	stw %r28,0(0,%r5) ;# 6111 reload_outsi+2/6
...
L$0623
	ldw 0(0,%r5),%r4 ;# 6055 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 6059 reload_outsi+2/5
...
L$0624
	...
	bl L$0043,0 ;# 6189 jump
	stbs,ma %r19,1(0,%r6) ;# 6177 movqi+1/6
L$0639
	ldw 4(0,%r5),%r20 ;# 8159 reload_outsi+2/5
...
L$0645
	...
	stw %r19,4(0,%r5) ;# 6234 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 6243 reload_outsi+2/6
L$0650
	ldw 0(0,%r5),%r26 ;# 6250 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 6254 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 6252 reload_outsi+2/5
	comiclr,<> 0,%r28,0 ;# 6262 bleu+1
	bl L$0953,0
	stw %r28,0(0,%r5) ;# 6258 reload_outsi+2/6
...
L$0643
	ldw 0(0,%r5),%r4 ;# 6202 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 6206 reload_outsi+2/5
...
L$0644
	...
	bl L$0043,0 ;# 6336 jump
	stbs,ma %r19,1(0,%r6) ;# 6324 movqi+1/6
L$0659
	ldw 4(0,%r5),%r20 ;# 8167 reload_outsi+2/5
...
L$0665
	...
	stw %r19,4(0,%r5) ;# 6378 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 6387 reload_outsi+2/6
L$0670
	ldw 0(0,%r5),%r26 ;# 6394 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 6398 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 6396 reload_outsi+2/5
	comiclr,<> 0,%r28,0 ;# 6406 bleu+1
	bl L$0953,0
	stw %r28,0(0,%r5) ;# 6402 reload_outsi+2/6
...
L$0663
	ldw 0(0,%r5),%r4 ;# 6346 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 6350 reload_outsi+2/5
...
L$0664
	...
	bl L$0043,0 ;# 6480 jump
	stbs,ma %r19,1(0,%r6) ;# 6468 movqi+1/6
L$0679
	ldw 4(0,%r5),%r20 ;# 8175 reload_outsi+2/5
...
L$0685
	...
	stw %r19,4(0,%r5) ;# 6522 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 6531 reload_outsi+2/6
L$0690
	ldw 0(0,%r5),%r26 ;# 6538 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 6542 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 6540 reload_outsi+2/5
	comiclr,<> 0,%r28,0 ;# 6550 bleu+1
	bl L$0953,0
	stw %r28,0(0,%r5) ;# 6546 reload_outsi+2/6
...
L$0683
	ldw 0(0,%r5),%r4 ;# 6490 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 6494 reload_outsi+2/5
...
L$0684
	...
	bl L$0043,0 ;# 6624 jump
	stbs,ma %r19,1(0,%r6) ;# 6612 movqi+1/6
L$0699
	ldw 4(0,%r5),%r20 ;# 8183 reload_outsi+2/5
...
L$0705
	...
	stw %r19,4(0,%r5) ;# 6666 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 6675 reload_outsi+2/6
L$0710
	ldw 0(0,%r5),%r26 ;# 6682 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 6686 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 6684 reload_outsi+2/5
	comiclr,<> 0,%r28,0 ;# 6694 bleu+1
	bl L$0953,0
	stw %r28,0(0,%r5) ;# 6690 reload_outsi+2/6
...
L$0703
	ldw 0(0,%r5),%r4 ;# 6634 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 6638 reload_outsi+2/5
...
L$0704
	...
	bl L$0043,0 ;# 6768 jump
	stbs,ma %r19,1(0,%r6) ;# 6756 movqi+1/6
L$0719
	ldw 4(0,%r5),%r20 ;# 8191 reload_outsi+2/5
...
L$0725
	...
	stw %r19,4(0,%r5) ;# 6810 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 6819 reload_outsi+2/6
L$0730
	ldw 0(0,%r5),%r26 ;# 6826 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 6830 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 6828 reload_outsi+2/5
	comiclr,<> 0,%r28,0 ;# 6838 bleu+1
	bl L$0953,0
	stw %r28,0(0,%r5) ;# 6834 reload_outsi+2/6
...
L$0723
	ldw 0(0,%r5),%r4 ;# 6778 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 6782 reload_outsi+2/5
...
L$0724
	...
	bl L$0043,0 ;# 6912 jump
	stbs,ma %r19,1(0,%r6) ;# 6900 movqi+1/6
L$0739
	ldw 4(0,%r5),%r20 ;# 8199 reload_outsi+2/5
...
L$0745
	...
	stw %r19,4(0,%r5) ;# 6954 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 6963 reload_outsi+2/6
L$0750
	ldw 0(0,%r5),%r26 ;# 6970 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 6974 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 6972 reload_outsi+2/5
	comiclr,<> 0,%r28,0 ;# 6982 bleu+1
	bl L$0953,0
	stw %r28,0(0,%r5) ;# 6978 reload_outsi+2/6
...
L$0743
	ldw 0(0,%r5),%r4 ;# 6922 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 6926 reload_outsi+2/5
...
L$0744
	...
	bl L$0043,0 ;# 7056 jump
	stbs,ma %r19,1(0,%r6) ;# 7044 movqi+1/6
L$0759
	ldw 4(0,%r5),%r20 ;# 8207 reload_outsi+2/5
...
L$0765
	...
	stw %r19,4(0,%r5) ;# 7098 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 7107 reload_outsi+2/6
L$0770
	ldw 0(0,%r5),%r26 ;# 7114 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 7118 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 7116 reload_outsi+2/5
	comiclr,<> 0,%r28,0 ;# 7126 bleu+1
	bl L$0953,0
	stw %r28,0(0,%r5) ;# 7122 reload_outsi+2/6
...
L$0763
	ldw 0(0,%r5),%r4 ;# 7066 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 7070 reload_outsi+2/5
...
L$0764
	...
	bl L$0043,0 ;# 7200 jump
	stbs,ma %r19,1(0,%r6) ;# 7188 movqi+1/6
L$0787
	bb,< %r15,17,L$0076 ;# 7216 bleu+3
	ldo -48(%r7),%r19 ;# 7224 addsi3/2
	ldw -260(0,%r30),%r1 ;# 8986 reload_outsi+2/5
	...
	ldw 0(0,%r5),%r4 ;# 8212 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 8215 reload_outsi+2/5
...
L$0796
	...
	stw %r19,4(0,%r5) ;# 7300 reload_outsi+2/6
	stw %r7,4(0,%r5) ;# 7309 reload_outsi+2/6
L$0801
	ldw 0(0,%r5),%r26 ;# 7316 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 7320 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 7318 reload_outsi+2/5
	comiclr,<> 0,%r28,0 ;# 7328 bleu+1
	bl L$0953,0
	stw %r28,0(0,%r5) ;# 7324 reload_outsi+2/6
...
L$0794
	ldw 0(0,%r5),%r4 ;# 7268 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 7272 reload_outsi+2/5
...
L$0795
	...
	stbs,ma %r19,1(0,%r6) ;# 7390 movqi+1/6
	bl L$0043,0 ;# 7405 jump
	stbs,ma %r3,1(0,%r6) ;# 7393 movqi+1/6
L$0811
	bb,< %r15,30,L$0104
	nop ;# 7414 bleu+3
L$0397
	...
	bl L$0816,0 ;# 7434 jump
	ldb 0(0,%r19),%r19 ;# 7433 zero_extendqisi2/2
L$0815
...
L$0076
	...
	ldb 0(0,%r9),%r20 ;# 7463 zero_extendqisi2/2
	...
	ldw -296(0,%r30),%r21 ;# 7476 reload_outsi+2/5
	ldb 0(0,%r21),%r19 ;# 7478 movqi+1/5
	...
	ldb 1(0,%r21),%r19 ;# 7510 movqi+1/5
...
L$0830
	...
	stw %r19,4(0,%r5) ;# 7636 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 7645 reload_outsi+2/6
L$0835
	ldw 0(0,%r5),%r26 ;# 7652 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 7656 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 7654 reload_outsi+2/5
	comiclr,<> 0,%r28,0 ;# 7664 bleu+1
	bl L$0953,0
	stw %r28,0(0,%r5) ;# 7660 reload_outsi+2/6
...
L$0828
	ldw 0(0,%r5),%r4 ;# 7604 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 7608 reload_outsi+2/5
...
L$0829
	...
	stbs,ma %r19,1(0,%r6) ;# 7726 movqi+1/6
	stbs,ma 0,1(0,%r6) ;# 7729 movqi+1/6
	ldo -1(%r6),%r9 ;# 7741 addsi3/2
L$0819
	ldw 0(0,%r5),%r4 ;# 8228 reload_outsi+2/5
L$1177
	ldw 4(0,%r5),%r20 ;# 8231 reload_outsi+2/5
...
L$0849
	...
	stw %r19,4(0,%r5) ;# 7783 reload_outsi+2/6
	stw %r3,4(0,%r5) ;# 7792 reload_outsi+2/6
L$0854
	ldw 0(0,%r5),%r26 ;# 7799 reload_outsi+2/5
	.CALL ARGW0=GR,ARGW1=GR
	bl realloc,%r2 ;# 7803 call_value_internal_symref
	ldw 4(0,%r5),%r25 ;# 7801 reload_outsi+2/5
	comiclr,<> 0,%r28,0 ;# 7811 bleu+1
	bl L$0953,0
	stw %r28,0(0,%r5) ;# 7807 reload_outsi+2/6
...
L$0847
	ldw 0(0,%r5),%r4 ;# 7751 reload_outsi+2/5
	ldw 4(0,%r5),%r20 ;# 7755 reload_outsi+2/5
	sub %r6,%r4,%r19 ;# 7752 subsi3/1
	ldo 1(%r19),%r19 ;# 7753 addsi3/2
	comb,<< %r20,%r19,L$0849
	nop ;# 7757 bleu+1
L$0848
	stbs,ma %r7,1(0,%r6) ;# 7872 movqi+1/6
	ldb 0(0,%r9),%r19 ;# 7885 movqi+1/5
	ldo 1(%r19),%r19 ;# 7888 addsi3/2
	stb %r19,0(0,%r9) ;# 7890 movqi+1/6
L$0043
	ldw -296(0,%r30),%r19 ;# 2328 reload_outsi+2/5
L$1161
	comclr,= %r16,%r19,0 ;# 258 bleu+1
	bl L$1178,0
	ldw -296(0,%r30),%r19 ;# 2334 reload_outsi+2/5
L$0044
...
L$0865
	ldw -304(0,%r30),%r19 ;# 7928 reload_outsi+2/5
	comib,<>,n 0,%r19,L$0866 ;# 7930 bleu+1
	.CALL ARGW0=GR
	bl free,%r2 ;# 7946 call_internal_symref
	ldw -312(0,%r30),%r26 ;# 7944 reload_outsi+2/5
	ldw 0(0,%r5),%r19 ;# 7949 reload_outsi+2/5
	ldi 0,%r28 ;# 7955 reload_outsi+2/2
	sub %r6,%r19,%r19 ;# 7950 subsi3/1
	bl L$0867,0 ;# 7957 jump
	stw %r19,8(0,%r5) ;# 7952 reload_outsi+2/6
L$0895
	.CALL ARGW0=GR
	bl free,%r2 ;# 2269 call_internal_symref
	ldw -312(0,%r30),%r26 ;# 2267 reload_outsi+2/5
	bl L$0867,0 ;# 2273 jump
	ldi 11,%r28 ;# 2271 reload_outsi+2/2
L$0900
	.CALL ARGW0=GR
	bl free,%r2 ;# 3161 call_internal_symref
	ldw -312(0,%r30),%r26 ;# 3159 reload_outsi+2/5
	bl L$0867,0 ;# 3165 jump
	ldi 4,%r28 ;# 3163 reload_outsi+2/2
L$0902
	.CALL ARGW0=GR
	bl free,%r2 ;# 3218 call_internal_symref
	ldw -312(0,%r30),%r26 ;# 3216 reload_outsi+2/5
	bl L$0867,0 ;# 3222 jump
	ldi 7,%r28 ;# 3220 reload_outsi+2/2
L$0903
	.CALL ARGW0=GR
	bl free,%r2 ;# 3803 call_internal_symref
	ldw -312(0,%r30),%r26 ;# 3801 reload_outsi+2/5
	bl L$0867,0 ;# 3807 jump
	ldi 5,%r28 ;# 3805 reload_outsi+2/2
L$0915
	.CALL ARGW0=GR
	bl free,%r2 ;# 5461 call_internal_symref
	ldw -312(0,%r30),%r26 ;# 5459 reload_outsi+2/5
	bl L$0867,0 ;# 5465 jump
	ldi 9,%r28 ;# 5463 reload_outsi+2/2
L$0917
	.CALL ARGW0=GR
	bl free,%r2 ;# 5557 call_internal_symref
	ldw -312(0,%r30),%r26 ;# 5555 reload_outsi+2/5
	bl L$0867,0 ;# 5561 jump
	ldi 13,%r28 ;# 5559 reload_outsi+2/2
L$0922
	bl L$0867,0 ;# 5983 jump
	ldi 14,%r28 ;# 5981 reload_outsi+2/2
L$0939
	.CALL ARGW0=GR
	bl free,%r2 ;# 7235 call_internal_symref
	ldw -312(0,%r30),%r26 ;# 7233 reload_outsi+2/5
	bl L$0867,0 ;# 7239 jump
	ldi 6,%r28 ;# 7237 reload_outsi+2/2
L$0944
	bl L$0867,0 ;# 7775 jump
	ldi 15,%r28 ;# 7773 reload_outsi+2/2
L$0866
	.CALL ARGW0=GR
	bl free,%r2 ;# 7935 call_internal_symref
	ldw -312(0,%r30),%r26 ;# 7933 reload_outsi+2/5
	ldi 8,%r28 ;# 7937 reload_outsi+2/2
L$0867
	ldw -340(0,%r30),%r2 ;# 9026 reload_outsi+2/5
	ldw -168(0,%r30),%r18 ;# 9028 reload_outsi+2/5
	ldw -164(0,%r30),%r17 ;# 9030 reload_outsi+2/5
	ldw -160(0,%r30),%r16 ;# 9032 reload_outsi+2/5
	ldw -156(0,%r30),%r15 ;# 9034 reload_outsi+2/5
	ldw -152(0,%r30),%r14 ;# 9036 reload_outsi+2/5
	ldw -148(0,%r30),%r13 ;# 9038 reload_outsi+2/5
	ldw -144(0,%r30),%r12 ;# 9040 reload_outsi+2/5
	ldw -140(0,%r30),%r11 ;# 9042 reload_outsi+2/5
	ldw -136(0,%r30),%r10 ;# 9044 reload_outsi+2/5
	ldw -132(0,%r30),%r9 ;# 9046 reload_outsi+2/5
	ldw -128(0,%r30),%r8 ;# 9048 reload_outsi+2/5
	ldw -124(0,%r30),%r7 ;# 9050 reload_outsi+2/5
	ldw -120(0,%r30),%r6 ;# 9052 reload_outsi+2/5
	ldw -116(0,%r30),%r5 ;# 9054 reload_outsi+2/5
	ldw -112(0,%r30),%r4 ;# 9056 reload_outsi+2/5
	ldw -108(0,%r30),%r3 ;# 9058 reload_outsi+2/5
	bv 0(%r2) ;# 9061 return_internal
