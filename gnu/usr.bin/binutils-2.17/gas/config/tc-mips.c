...
/*  Return true if ISA supports 64 bit wide gp register instructions.  */
...
static const struct mips_cpu_info mips_cpu_info_table[] =
{
  ...
  /* XXX: First step to full Loongson support. */
  /* Not just a mips3, not quite anything else. */
  /* Comment out for now to avoid build errors.
