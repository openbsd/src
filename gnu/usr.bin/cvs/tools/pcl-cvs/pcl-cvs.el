...
;;;
;;;#ident "@(#)cvs/contrib/pcl-cvs:$Name:  $:$Id: pcl-cvs.el,v 1.1.1.4 1998/02/22 08:22:13 tholo Exp $"
;;;
...
ERR-BUF should be 'STDOUT or 'STDERR."
  ...
  (let* ((stdout (save-excursion (set-buffer stdout-buffer) (buffer-string)))
    ...
    (insert "CVS Version: "
	    "@(#)cvs/contrib/pcl-cvs:$Name:  $:$Id: pcl-cvs.el,v 1.1.1.4 1998/02/22 08:22:13 tholo Exp $\n\n")
