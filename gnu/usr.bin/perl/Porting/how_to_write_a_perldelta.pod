...
and the preceding version from which that perldelta describes changes:
...
For a release on a stable branch, this will reference the two preceding
stable releases. For example, the 5.12.1 perldelta will reference the
5.12.0 perldelta describing differences between 5.10.0 and 5.12.0;
the 5.12.4 perldelta will reference the 5.12.3 perldelta describing
differences between 5.12.2 and 5.12.3.
