...
# module: Unicode::UCD::prop_invmap('NFKC_Simple_Casefold') (Values for individual
...
# map to.
$Unicode::UCD::SwashInfo{'ToNFKCSCF'}{'format'} = 'x'; # non-negative hex whole number; a code point
$Unicode::UCD::SwashInfo{'ToNFKCSCF'}{'specials_name'} = 'Unicode::UCD::ToSpecNFKCSCF'; # Name of hash of special mappings
$Unicode::UCD::SwashInfo{'ToNFKCSCF'}{'missing'} = '<code point>'; # code point maps to itself
